                ...
                <div className="container about-section">
                    <div className="row">
                        <div className="col-lg-8 col-md-10 mx-auto">
                            ...
                            <p>
                                While I'm not coding or doing stuff related to tech, you can find me reviewing a book <a target="_blank" rel="noopener noreferrer" href="https://www.goodreads.com/user/show/26453047-avanthika">online</a> or in a library. Or spending time with my cat, Anjali. She's a 3 year old white "Bombay cat" (that's what they call native Indian cats), with beautiful yellow eyes.
                            </p>
